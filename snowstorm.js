...
function SnowStorm() {
  ...
  this.resizeHandlerAlt = function () {
    screenX =
      s.targetElement.offsetLeft +
      s.targetElement.offsetWidth -
      s.flakeRightOffset;
    screenY = s.flakeBottom
      ? s.flakeBottom
      : s.targetElement.offsetTop + s.targetElement.offsetHeight;
    screenX2 = parseInt(screenX / 2, 10);
  };
        ...
        if (storm.useTwinkleEffect) {
          if (!s.twinkleFrame) {
            ...
            s.o.style.visibility =
              s.twinkleFrame && s.twinkleFrame % 2 === 0 ? "hidden" : "visible";
          }
        }
      }
    };
  ...
  this.createSnow = function (limit, allowInactive) {
    for (var i = 0; i < limit; i++) {
      s.flakes[s.flakes.length] = new s.SnowFlake(
        s,
